...
; Include C header files
                .cdecls "stdint.h","stdbool.h","inc/hw_memmap.h","inc/hw_ints.h","driverlib/sysctl.h","driverlib/gpio.h","driverlib/pin_map.h","driverlib/timer.h","launchpad.h","pwmled.h"
                .text
...
;
                .asmfunc
pwmledSetColor  PUSH    {lr, r2, r1, r0}            ; Push r0, r1 and r2 for later function calls

                ; Set the period and duty cycle length for the red sub-LED
                ...
                LDR     r0, TIMER1
                MOV     r1, #TIMER_B
                LDR     r2, [sp, #4]                ; r2 = pushed r1 (green)
                MOV     r2, r2, LSR #16             ; r2 = green.period
                BL      TimerLoadSet
